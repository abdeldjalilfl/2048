...
public class MainView extends View {
    ...
    private void drawHeader(Canvas canvas) {
        ...
        canvas.drawText(getResources().getString(R.string.app_name), startingX, headerStartY, paint);
    }
